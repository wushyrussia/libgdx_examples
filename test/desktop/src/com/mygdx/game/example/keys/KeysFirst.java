...
public class KeysFirst extends ApplicationAdapter {
    //base
    SpriteBatch batch;
...
//        debugRenderer.setDrawAABBs(true);
        ...
        Vector2 circlePosition = new Vector2(32, 57);
        dynamicCircle = new DynamicCircle(world, circlePosition, 2);
        inputProcessor.setDynamicCircle(dynamicCircle);
    }
